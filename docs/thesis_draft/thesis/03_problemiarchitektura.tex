...
Zadanie predykcji brakujących krawędzi sprowadza się do~klasyfikacji
...
Ze~względu na~strukturę grafu DLG-DG-23 kandydatami do~predykcji
...
— pary te nie~są przedmiotem predykcji. Ograniczenie przestrzeni
...
(\emph{splitter}), właściwych algorytmów predykcji oraz modułu
ewaluacji.
...
grafu lineage jest wystarczająca do~predykcji zerwanych zależności.
...
krawędzi. Podejście to jest standardowe w~literaturze predykcji
...
W~pracy zaimplementowano trzy grupy algorytmów predykcji
...
co~dyskwalifikuje je~jako metody predykcji w~omawianym scenariuszu.
...
Klasyczne metody uczenia maszynowego traktują problem predykcji krawędzi
...
niezbalansowaniu klas, typowym dla~problemu predykcji krawędzi
...
Predykcja krawędzi wymaga przekształcenia pary zanurzeń węzłów
