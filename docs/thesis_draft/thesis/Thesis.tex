...
jakości~\cite{Psallidas2022,Yamada2023}.
...
niniejszej pracy jest zastosowanie algorytmów wykrywania brakujących krawędzi
...
grafu zależności w~warstwie ETL(\emph{Extract, Transform, Load}) uniemożliwia przeprowadzenie takiego audytu.
...
i~pełną interpretowalością, co czyni je naturalnym punktem odniesienia
...
i~węzła $v$, a~$|\cdot|$ denotes rozmiar zbioru, tj.\ stopień węzła w~grafie.
