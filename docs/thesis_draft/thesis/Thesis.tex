...
\begin{enumerate}
  ...
  \item \textbf{Klasyczne metody ML} — Random Forest, RUSBoost i~LightGBM;
        ...
        w~tym cechy strukturalne grafu natomiast metryki podobieństwa nazw (np. Jaro-Winkler) 
        nie mogą być zastosowane, ponieważ zbiór DLG-DG-23 używa zanonimizowanych 
