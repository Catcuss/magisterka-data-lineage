...
\subsection{An open dataset of data lineage graphs \cite{Chen2023}}
...
SQL~\cite{Dietrich2023}, analizy logów systemowych~\cite{Psallidas2020},
heterogenicznych grafowych sieci neuronowych (ang. \emph{Graph Neural
Network}, GNN)~\cite{Shan2022} oraz rozszerzonego \emph{lineage}
